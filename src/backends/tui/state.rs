...
pub struct App {
    ...
    pub sessions: Vec<crate::api::types::SessionSummary>,  // Session列表
    pub providers: Vec<crate::api::types::ProviderInfo>,   // Provider列表
    ...
    pub fn new() -> Self {
        ...
        Self {
            ...
            available_commands: vec![
                "/quit", "/session", "/new", "/providers", "/models",
                "/tasks", "/notifications", "/chat", "/back"
            ],
