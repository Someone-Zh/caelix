...
pub struct ProviderManager {
    /// 存储提供者的哈希映射，键为提供者名称
    providers: HashMap<String, Arc<dyn caelix_api::provider::LlmProvider>>,
...
impl ProviderManager {
    ...
    pub fn get_provider(&self, name: &str) -> Option<&Arc<dyn caelix_api::provider::LlmProvider>> {
    ...
    pub fn get_all_providers(&self) -> Vec<(String, Arc<dyn caelix_api::provider::LlmProvider>)> {
        self.providers.iter()
