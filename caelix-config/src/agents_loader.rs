use crate::managers::{AgentRegistryError, ToolManager, AgentManager};
...
pub async fn register_all_agents<T>(context: &T, directory_path: &str) -> Result<(), AgentRegistryError>
where
